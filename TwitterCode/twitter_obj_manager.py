...
mfo = ManageFlowObj('twitter_values_sirens.txt', 'sirens_trait_db.json')  # will print traits using DB
# or
mfo2 = ManageFlowObj('twitter_values_sirens.txt', True)  # will print traits using asset endpoint
# or
mfo3 = ManageFlowObj('twitter_values_sirens.txt', False)  # will NOT print traits
# mfo3 is equivalent to "mfo3 = ManageFlowObj('twitter_values_sirens.txt')"
